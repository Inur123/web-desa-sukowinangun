...
@section('title', 'Layanan Surat Domisili - Sukowinangun')
    ...
    <section class="pt-16 bg-gradient-to-r from-primary to-secondary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div class="text-center text-white">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">Form Pengajuan Surat Domisili</h1>
                <p class="text-base sm:text-lg md:text-xl text-gray-100 max-w-3xl mx-auto px-2 sm:px-0">
                    Ajukan permohonan Surat Domisili untuk keperluan administrasi.
                </p>
            </div>
        </div>
    </section>
                        ...
                        <form action="{{ route('domisili.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="alamat_domisili" name="alamat_domisili" rows="3" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent"
                                            placeholder="Jalan, nomor rumah, RT/RW domisili"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 md:gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="keperluan" name="keperluan" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent"
                                            placeholder="Contoh: Administrasi sekolah, pindah domisili, dll">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-t pt-6">
                                <button type="submit"
                                    ...
                                    Ajukan Permohonan Surat Domisili
                                </button>
                            </div>
                        </form>
                    </div>
