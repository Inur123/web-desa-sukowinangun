...
@section('title', 'Layanan Surat Harga Tanah - Sukowinangun')
    ...
    <section class="pt-16 bg-gradient-to-r from-primary to-secondary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div class="text-center text-white">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">Form Pengajuan Surat Harga Tanah</h1>
                <p class="text-base sm:text-lg md:text-xl text-gray-100 max-w-3xl mx-auto px-2 sm:px-0">
                    Ajukan permohonan Surat Harga Tanah untuk keperluan administrasi terkait harga tanah.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="flex justify-center">
                <div class="w-full lg:w-2/3">
                    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
                        <form action="{{ route('harga-tanah.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            @csrf
                            <!-- Data Pribadi -->
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" id="ttl" name="ttl" value="{{ old('ttl') }}" required placeholder="YYYY-MM-DD"
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent">
                                        </div>
                            ...
                            <div class="border-t pt-6">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                    <i class="fas fa-landmark mr-2 text-secondary"></i>
                                    Data Harga Tanah
                                </h3>

                                <div class="grid grid-cols-1 gap-4 md:gap-6">
                                    <div>
                                        <label for="alamat_tanah" class="block text-sm font-medium text-gray-700 mb-2">Alamat Tanah</label>
                                        <textarea id="alamat_tanah" name="alamat_tanah" rows="3" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent"
                                            placeholder="Lokasi tanah">{{ old('alamat_tanah') }}</textarea>
                                    </div>

                                    <div>
                                        <label for="harga_per_meter" class="block text-sm font-medium text-gray-700 mb-2">Harga per Meter Persegi</label>
                                        <input type="text" id="harga_per_meter" name="harga_per_meter" value="{{ old('harga_per_meter') }}" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent"
                                            placeholder="Contoh: 27jt atau 20juta">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="keperluan" name="keperluan" value="{{ old('keperluan') }}" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent"
                                            placeholder="Contoh: Pengurusan sertifikat, jual beli tanah, dll">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-t pt-6">
                                <button type="submit"
                                    ...
                                    Ajukan Permohonan Surat Harga Tanah
                                </button>
                            </div>
                        </form>
                    </div>
