<nav class="bg-white shadow-lg fixed w-full top-0 z-50">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="{{ route('layanan.index') }}"
                        class="{{ request()->is('layanan*') ? 'text-primary bg-primary/10' : 'text-gray-700 hover:text-primary' }} px-3 py-2 rounded-md text-sm font-medium transition-colors">
                        Layanan
                    </a>
                    ...
                    <a href="{{ route('kontak.index') }}"
                        class="{{ request()->routeIs('kontak.index') ? 'text-primary bg-primary/10' : 'text-gray-700 hover:text-primary' }} px-3 py-2 rounded-md text-sm font-medium transition-colors">
                        Kontak
                    </a>
                </div>
            </div>
    ...
    <div id="mobile-menu" class="md:hidden hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
            ...
            <a href="{{ route('layanan.index') }}"
                class="{{ request()->is('layanan*') ? 'text-primary bg-primary/10' : 'text-gray-700 hover:text-primary' }} block px-3 py-2 rounded-md text-base font-medium">
                Layanan
            </a>
            <a href="{{ route('berita.index') }}"
            ...
            <a href="{{ route('kontak.index') }}"
                class="{{ request()->routeIs('kontak.index') ? 'text-primary bg-primary/10' : 'text-gray-700 hover:text-primary' }} block px-3 py-2 rounded-md text-base font-medium">
                Kontak
            </a>
        </div>
    </div>
