    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <button id="menu-button" class="md:hidden text-gray-700 hover:text-primary focus:outline-none focus:text-primary" aria-label="Toggle navigation menu">
                    <i id="menu-icon" class="fas fa-bars text-xl"></i>
                </button>
                <div id="nav-menu" class="hidden md:flex md:items-baseline md:space-x-4 absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent border-t md:border-none px-2 md:px-0 pt-2 md:pt-0 pb-3 md:pb-0">
                    <a href="{{ route('home') }}"
