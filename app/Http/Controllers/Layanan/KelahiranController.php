    ...
    public function store(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'surat_keterangan_bidan_file' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:5120',
                ...
                'surat_keterangan_bidan_file.max' => 'File Surat Keterangan Bidan tidak boleh lebih dari 5MB',
            ]);
